 ...
 *
 * @dev copy from https://github.com/automata-network/automata-dcap-attestation/blob/main/contracts/interfaces/IAttestation.sol
 */
interface IDcapAttestation {
     ...
     */
    function verifyAndAttestOnChain(bytes calldata input) external view returns (bool success, bytes memory output);
